...
const UncategoryBrands: React.FC = () => {
  ...
  return (
    <BrandWrapper>
      ...
      <BrandCard>
        <TabNav>
          <TabButton  onClick={()=> navigate('/pages/totalbrands')}>Categories</TabButton>
          <TabButton active>Uncategories</TabButton>
        </TabNav>
...
export default UncategoryBrands;
